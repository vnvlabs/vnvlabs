...
def ACTION(stage, extra=[]):
    ...
    b = [{
        ...
        "run": "python .github/workflows/rebuild_containers_.py --gen 0 --push --stage " + stage.strip()
    }]
...
gui_extra = [
    {
        ...
        "run": "git submodule update --init gui"
    },
    {
        "name": "Load Paraview from the Cache if it exists",
